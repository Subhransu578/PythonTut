class Ticket:
    counter=0 
    def _init_(self,passenger_name,source,destination):
    ...
    def validate_source_destination(self):
        if (self._source=="Delhi" and (self.destination=="Pune" or self.destination=="Mumbai" or self.destination=="Chennai" or self._destination=="Kolkata")):
            return True
        else:
            return False
    ...
    def generate_ticket(self ):
        if True:
            _ticket_id=self.source[0]+self._destination[0]+"0"+str(self.Counter)
